...
/// The refquest spec_v1.json shape, loaded verbatim.
#[derive(Debug, Clone, serde::Deserialize)]
...
impl NeedleSpec {
    pub fn load(path: &Path) -> LibQuestResult<Self> {
...
impl NeedleRig<'_> {
    fn encoded_len(&self, text: &str) -> LibQuestResult<usize> {
...
pub fn run_needle_cells(
    ...
    mode: NeedleMode,
    lengths: &[usize],
) -> LibQuestResult<Vec<NeedleCellResult>> {

...
impl questness::evaluate::QuestnessEvaluator {
    ...
    pub fn signature_of(&self, source: &str) -> HarnessQuestResult<NuSignature> {
    ...
    #[allow(dead_code)]
    pub fn infer_nu(&self, source: &str) -> HarnessQuestResult<bridge::InferNu> {
...
pub fn form_of(signature: &NuSignature, source: &str) -> HarnessQuestResult<bridge::InferNu> {
...
fn check_prototype(signature: &NuSignature, wants_env: bool) -> HarnessQuestResult<()> {

...
impl ThinkHarness {
    ...
    pub fn assemble(&self, request: &turn::Request) -> HarnessQuestResult<turn::Assembled> {
    ...
    pub fn step(&mut self, emission: &str, insufficient: bool) -> HarnessQuestResult<Step> {
    ...
    pub fn resume(&mut self, value: &nu::Value) -> HarnessQuestResult<String> {
    ...
    fn repl(&mut self, source: &str) -> HarnessQuestResult<Step> {

...
impl SessionLog {
    ...
    pub fn open(root: &Path, segments: &[&str]) -> HarnessQuestResult<Self> {
    ...
    pub fn append(&self, label: &str, body: &str) -> HarnessQuestResult<()> {
    ...
    pub fn read(&self) -> HarnessQuestResult<String> {

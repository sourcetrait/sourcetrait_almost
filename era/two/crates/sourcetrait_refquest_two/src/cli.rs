//! The refquest command-line surface: verbs over ai2's original stack.
use crate::*;
...
/// Arguments for `refquest eval needle`.
#[derive(Debug, clap::Args)]
...
/// Arguments for `refquest generate`. Prompts ride files, never argv.
#[derive(Debug, clap::Args)]

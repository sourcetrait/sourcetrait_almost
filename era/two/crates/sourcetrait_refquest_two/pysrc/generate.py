"""refquest generate driver: original-stack (transformers) generation.

Pinned script shipped with the sourcetrait_refquest crate and materialized
into the refquest data home; invoked by the `refquest generate` verb through
...
def parse_args(argv):
    ap = argparse.ArgumentParser(prog="refquest-generate", description=__doc__)

...
pub struct HybridModel<B: Backend> {
    pub embed_rows: Vec<f32>,
    pub hidden: usize,
    pub layers: Vec<HybridBlock<B>>,
    pub final_norm: FloatTensor<B, 1>,
    pub lm_head_transposed: FloatTensor<B, 2>,
...
pub struct GdnBlock<B: Backend> {
    pub input_norm: FloatTensor<B, 1>,
    pub post_attention_norm: FloatTensor<B, 1>,
    pub q_transposed: FloatTensor<B, 2>,
    pub k_transposed: FloatTensor<B, 2>,
    pub v_transposed: FloatTensor<B, 2>,
    pub g_transposed: FloatTensor<B, 2>,
    pub o_transposed: FloatTensor<B, 2>,
    pub a_transposed: FloatTensor<B, 2>,
    pub b_transposed: FloatTensor<B, 2>,
    pub q_conv_taps: Vec<FloatTensor<B, 2>>,
    pub k_conv_taps: Vec<FloatTensor<B, 2>>,
    pub v_conv_taps: Vec<FloatTensor<B, 2>>,
    pub a_log_row: FloatTensor<B, 2>,
    pub dt_bias_row: FloatTensor<B, 2>,
    pub o_norm: FloatTensor<B, 1>,
    pub gate_transposed: FloatTensor<B, 2>,
    pub up_transposed: FloatTensor<B, 2>,
    pub down_transposed: FloatTensor<B, 2>,
}
...
pub struct AttnBlock<B: Backend> {
    ...
    pub v_transposed: FloatTensor<B, 2>,
    pub o_transposed: FloatTensor<B, 2>,
    pub q_norm: FloatTensor<B, 1>,
    pub k_norm: FloatTensor<B, 1>,
    pub post_attention_norm: FloatTensor<B, 1>,
    pub post_feedforward_norm: FloatTensor<B, 1>,
    pub gate_transposed: FloatTensor<B, 2>,
    pub up_transposed: FloatTensor<B, 2>,
    pub down_transposed: FloatTensor<B, 2>,
}
...
impl<B: Backend> HybridModel<B> {
    ...
    pub fn embed(&self, ids: &[u32]) -> FloatTensor<B, 2> {
        let n = ids.len();
    ...
    pub fn forward_all(&self, ids: &[u32]) -> LibQuestResult<(usize, Vec<f32>)> {
        let n = ids.len();
...
pub fn causal_mask<B: Backend>(n: usize, device: &B::Device) -> FloatTensor<B, 2> {

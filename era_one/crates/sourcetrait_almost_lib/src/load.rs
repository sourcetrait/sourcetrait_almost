...
pub fn pick_device(force_cpu: bool) -> AlmostResult<candle_core::Device> {
    if force_cpu {
...
pub fn pick_dtype(flag: Option<&str>, device: &candle_core::Device) -> AlmostResult<candle_core::DType> {
    match flag {
